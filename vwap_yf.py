...
def calc_vwap_for_symbol(symbol: str, date_str: str, interval: str = "1m"):
    """
    ...
    print(f"[DEBUG] Downloading {symbol} {date_str} {interval} data ...")
    ...
    print(f"[DEBUG] df.shape = {df.shape}, rows = {len(df)}")  # 顯示總筆數
